...
### Snapshot
[Snapshot](.npx playwright-cli/page-2026-02-14T19-22-42-679Z.yml)
```
...
In some cases user might want to install npx playwright-cli locally. If running globally available `npx playwright-cli` binary fails, use `npx playwright-cli` to run the commands. For example:
